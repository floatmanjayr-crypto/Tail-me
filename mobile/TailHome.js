  ...
  const DEMO_TAILS = [
    {
      ...
      from: "jordan.archivo",
      frameLayout: "A",
      boxes: [{ type: "video", uri: "https://videos.pexels.com/video-files/3163534/3163534-sd_640_360_30fps.mp4" }, { type: "reveal", uri: "https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=600" }, { type: "logo", text: "ARCHIVE" }],
    ...
    },
    {
      ...
      from: "maya.eats.nyc",
      frameLayout: "B",
      boxes: [{ type: "video", uri: "https://videos.pexels.com/video-files/3163534/3163534-sd_640_360_30fps.mp4" }, { type: "reveal" }],
    ...
    },
    {
      ...
      from: "dre.williams",
      frameLayout: "E",
      boxes: [{ type: "video", uri: "https://videos.pexels.com/video-files/3209828/3209828-sd_640_360_25fps.mp4" }, { type: "voice" }, { type: "reveal" }],
    ...
    },
    {
      ...
      from: "techdrops_",
      frameLayout: "D",
      boxes: [{ type: "video", uri: "https://videos.pexels.com/video-files/4793504/4793504-sd_640_360_25fps.mp4" }, { type: "text", text: "LOWEST PRICE EVER" }, { type: "reveal" }],
    ...
    },
    {
      ...
      from: "coach.rina.fit",
      frameLayout: "C",
      boxes: [{ type: "reveal", uri: "https://videos.pexels.com/video-files/3045163/3045163-sd_640_360_25fps.mp4" }],
    ...
    <View style={{ flex: 1 }}>
      ...
      {activeTab === "grid" && (
        <View style={{ flex: 1 }}>
          ...
          {/* Expanded reveal - SplitFrame Modal */}
          {expandedTail && (
            <View style={{
              position: "absolute",
              ...
              <TouchableOpacity
                style={{
                  position: "absolute", top: 50, right: 20, zIndex: 110,
