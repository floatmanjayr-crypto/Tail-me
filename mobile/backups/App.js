...
export default function App() {
  ...
  const [showStorefrontCustomizer, setShowStorefrontCustomizer] = useState(false);
      ...
      {screen === "profile" && me && profileUser && (
        <View style={{ flex: 1, paddingBottom: 92 }}>
          <ProfileScreen
            ...
            onOpenStorefrontSettings={() => setShowStorefrontSettings(true)}
            colors={C}
          />
        </View>
      )}
      ...
      {showStorefrontSettings && (
        <View style={{ position: "absolute", top: 0, left: 0, right: 0, bottom: 0, zIndex: 999 }}>
          <StorefrontSettings
            ...
            currentCover={me?.storefrontCover}
