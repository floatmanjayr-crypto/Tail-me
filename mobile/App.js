...
export default function App() {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: C.bg }}>
      ...
      {/* EARNINGS (sub-screen — accessed from Settings) */}
      {screen === "earnings" && me && (
        <View style={{ flex: 1, paddingBottom: 92 }}>
          <EarningsScreen
            me={me}
        ...
        <View style={{ flex: 1, paddingBottom: 92 }}>
          ...
          >
            ...
            >
              ...
              >
                <Text style={{ color: C.brand, fontWeight: "900" }}>
                  View Full Earnings →
                </Text>
              </TouchableOpacity>
              ...
              {!isPro && (
                ...
                >
                  ...
                  >
                    ✨ Upgrade to Pro — earn on every catch
                  </Text>
                </TouchableOpacity>
              )}
            </View>
